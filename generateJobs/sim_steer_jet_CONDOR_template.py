#This steering file only works with the mucoll-ilc-framework:1.6-centos8 software package 
...
SIM.compactFile = "inputFiles/MuColl_10TeV_v0A/MuColl_10TeV_v0A.xml"
...
SIM.inputFiles = ["inputFiles/5TeV_pythia8_events.hepmc"]
# Macro file to execute for runType 'run' or 'vis'
SIM.macroFile = ""
# number of events to simulate, used in batch mode
SIM.numberOfEvents = 10
# Outputfile from the simulation,only lcio output is supported
SIM.outputFile = "higgs_z_jet_10000_foo.slcio"
